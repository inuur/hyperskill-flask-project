...
ZIP_DOWNLOAD_PATH = f'driver{os.sep}driver.zip'
WINDOWS_DRIVER_PATH = f'driver{os.sep}chromedriver.exe'
LINUX_DRIVER_PATH = f'driver{os.sep}chromedriver'
MAC_DRIVER_PATH = f'driver{os.sep}chromedriver'
